...
@Component({
  selector: 'app-dashbord-professor',
  standalone: true,
  imports: [],
  templateUrl: './dashbord-professor.component.html',
  styleUrl: './dashbord-professor.component.css'
})
export class DashbordProfessorComponent {
